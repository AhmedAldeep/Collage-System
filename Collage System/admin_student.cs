...
{
    public partial class admin_student : UserControl
    {
        ...
        private void bunifuFlatButton2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                d.Close();
                string Q = "update  co_st_take set course1='"+r1+"',course2='"+r2+"',course3='"+r3+"',course4='"+4+"') ";
                SqlCommand cmd2 = new SqlCommand(Q, con);
                try
                {
                    cmd2.ExecuteNonQuery();
                    MetroFramework.MetroMessageBox.Show(this, "\n\n\t INFORMATION EDIT SUCCEFULLY  ");
                }
                catch (Exception ex)
                {
                    MetroFramework.MetroMessageBox.Show(this, ex.Message);
        ...
        private void bunifuFlatButton3_Click(object sender, EventArgs e)
        {
            ...
            string query1 = "Delete from co_st_take where student_id ='" + this.label4.Text + "' ;";
