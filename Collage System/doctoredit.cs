...
{
    public partial class doctoredit : UserControl
    {
        public doctoredit()
        {
            InitializeComponent();
        ...
        private void bunifuFlatButton2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "update Doctor set email='" + this.bunifuMaterialTextbox5.Text + "',password='" + this.bunifuMaterialTextbox2.Text + "',address='" + this.bunifuMaterialTextbox7.Text + "',phone='" + this.bunifuMaterialTextbox6.Text + "' where username ='" + this.bunifuMaterialTextbox10.Text + "' ;";
